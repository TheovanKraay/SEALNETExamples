        ...
        */
        ...
        public static void Main()
        {
            while (true)
            {
                ...
                Console.WriteLine("  6. addNumbers (simple addition)");
                Console.WriteLine("  7. Text Processing");
        ...
        {
            PrintExampleBanner("Text Processing:");
            ...
            var plain1 = encoder.Encode(var1);
            var plain2 = encoder.Encode(var2);
            Console.WriteLine($"Encoded {var1} as polynomial {plain1} (plain2)");
            Console.WriteLine($"Encoded {var2} as polynomial {plain2} (plain2)");

            Console.WriteLine("Encrypting the integers...");
            encryptor.Encrypt(plain1, encrypted1);
            encryptor.Encrypt(plain2, encrypted2);

            Console.WriteLine("Done: encrypted the values.");

            Console.WriteLine("Doing the computation on the encrypted integers (simple addition)...");
        ...
        {
            PrintExampleBanner("Simple addition on integers while encrypted");
            ...
            //perform simple addition on the encrypted integers
            Console.WriteLine("Done: encrypted the values.");
            Console.WriteLine("Doing the computation on the encrypted integers...");
            evaluator.Add(encrypted1, encrypted2);
